...
const Package = ({ packages }) => {
    ...
    return (
        <div className='flex flex-col text-center shadow-sm shadow-fuchsia-200' >
            <img src={img} alt="" className='p-2 cursor-pointer' 
            ...
            <button className='border border-fuchsia-700 py-2 font-medium uppercase hover:bg-fuchsia-700 hover:text-white hover:transition hover:duration-500'
                onClick={() => navigateService(_id)}>Checkout &nbsp;

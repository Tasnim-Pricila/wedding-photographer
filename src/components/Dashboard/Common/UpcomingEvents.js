...
const UpcomingEvents = () => {
  ...
  const eventForUser = upcoming.filter((e) => e.userId === userId);
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 lg:grid-cols-3 xl:grid-cols-4">
        {role === "admin" &&
          ...
          upcoming?.map((data) => (
            <div
              key={data._id}
              className="rounded overflow-hidden shadow-lg px-4 py-4 bg-slate-300 pb-10 border-b-8 border-t-2 border-l-2 border-r-2 border-b-purple-500 hover:border-t-2 hover:border-l-2 hover:border-r-2 hover:border-purple-500 hover:duration-1000"
            >

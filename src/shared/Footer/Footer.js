import { faFacebook, faFacebookF, faGoogle, faGooglePlus, faGooglePlusG, faTwitter } from '@fortawesome/free-brands-svg-icons';
...
const Footer = () => {
    ...
    return (
        <>
            <div className='grid grid-cols-4 bg-[#2C2727] px-24 gap-12 py-20 justify-center'>
                <div>
